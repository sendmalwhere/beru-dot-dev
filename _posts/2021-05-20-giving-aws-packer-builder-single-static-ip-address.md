...
The configuration basically looked like this before I started messing around with the EIP stuff:
```hcl
...
## The Answer: Face Your Fears (Face `cloud-init`)
